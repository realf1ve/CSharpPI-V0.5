...
insert into tbFunc(nome,nascimento,turma,cpf,telCel,emailpessoal,endereco,numero,bairro,cidade,estado,cep,responsavel) 
values('Willian Brito','1991/05/22','','403.180.848-80','(11) 96624-0614','willianhenriquevb@gmail.com','Av. João Caiaffa','40','Vila Sônia','São Paulo','SP','05742-100','');

insert into tbFunc(nome,nascimento,turma,cpf,telCel,emailpessoal,endereco,numero,bairro,cidade,estado,cep,responsavel) 
values('Kaio Silva','2005/01/04','','403.180.848-70','(11) 96624-0614','willianhenriquevb@gmail.com','Av. João Caiaffa','40','Vila Sônia','São Paulo','SP','05742-100','');

insert into tbFunc(nome,nascimento,turma,cpf,telCel,emailpessoal,endereco,numero,bairro,cidade,estado,cep,responsavel) 
values('Mathias Familia','2004/01/02','','403.180.848-60','(11) 96624-0614','willianhenriquevb@gmail.com','Av. João Caiaffa','40','Vila Sônia','São Paulo','SP','05742-100','');
...
insert into tbUsuario(usuario,senha,codFunc,codCategoria,codTipos) values('kaio.silva','123456',2,6,4);
